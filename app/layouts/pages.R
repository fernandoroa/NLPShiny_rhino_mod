box::use(
  shiny[
    bootstrapPage, NS, renderText, tags,
    ...
    splitLayout(
      ...
      tagList(
        ...
        div(
          ...
          segment(
            style = "margin: 20px 5px 0; padding:12px 20px 0 20px;",
            card1
          ),
          segment(
            style = "margin: 20px 5px 0; padding:12px 20px 0 20px;",
        ...
        div(
          ...
          div(
            style = "height:5vh;margin: 0px 5px 0; padding:20px 10px 0 10px;",
            semanticPage(
              tabset(
                id = "mini_tabset",
                tabs = list(
                  list(
                    ...
                    content =
                      div(
                        style = "height: 12vh;min-height: 190px;padding-top:5px;",
                        card4
                      )
                  ),
                  list(
